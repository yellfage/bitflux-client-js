...
export class DefaultReconnectionSettings implements ReconnectionSettings {
  ...
  public approveAttempt: Callback<
    [ReconnectionAttemptApprovingContext],
    boolean
  >
  ...
  public constructor() {
    ...
    this.approveAttempt = this.approveAttemptDefault
  }

  private approveAttemptDefault(context: ReconnectionAttemptApprovingContext) {
    return (
